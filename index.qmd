...
- Often associated with satellite imagery and remote sensing data
  - gridded observations where each pixel represents a measurement at regular spatial intervals
...
For example, the same location (Quebec City) can be expressed in three formats:

- **Decimal Degrees (DD)**: `46.8139, -71.2082` [Recommended]{.emphasize}
- **Degrees Decimal Minutes (DDM)**: `46° 48.833'N, 71° 12.498'W`
- **Degrees Minutes Seconds (DMS)**: `46° 48' 50.0"N, 71° 12' 29.9"W`

[The decimal degrees format is the standard in most modern GIS and mapping applications.]{.emphasize}
