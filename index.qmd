...
For example, the `.xlsx` file format is not open source. It is a proprietary file format developed by Microsoft.
...
![](img/logo/doaj_logo.png){.r-stretch, .center-align fig-alt="Directory of Open Access Journals logo. The logo has three shapes on the left side and the text 'DOAJ' on the right side."}
